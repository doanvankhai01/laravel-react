 ...
 *
 *   @OA\Property(property="name", type="string", description="Name of the type code"),
 *   @OA\Property(property="code", type="string", description="Code of the type code"),
 *   @OA\Property(property="description", type="string", description="Description of the type code"),
 *   @OA\Property(property="codes", type="array", description="List code", @OA\Items(ref="#/components/schemas/Code")),
 * )
 */
